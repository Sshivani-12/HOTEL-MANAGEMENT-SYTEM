...
public class HOTELMANAGEMENT extends JFrame implements ActionListener{
 HOTELMANAGEMENT(){
        setBounds(20,200,1366,565);//combination of setvisibility and location
    //setSize(400,400);
    //setLocation(300,300);
...
add(l1);
    ...
    l2.setBounds(20,430,900,90); //y axis,x axis,size
    l2.setForeground(Color.WHITE);//in awt packet
